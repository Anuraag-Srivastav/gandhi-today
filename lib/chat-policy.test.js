...
describe("source probes", () => {
  for (const question of ["source please", "citation?", "Which exact passage supports that?", "Are you certain about that source?", "Search online for further reading", "What can I read and can you verify it?", "how do you say that", "Can you identify a source for that date?"]) {
    test(question, () => expect(isSourceProbe(question)).toBe(true));
  }
  for (const question of ["What can I read on this?", "Suggest further reading", "Which part of that is your inference?", "What did Gandhi think about money?", "What is AI?", "Should I learn it?", "What were his sources of income?"]) {
