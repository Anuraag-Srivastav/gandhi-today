...
Check the whole result, not only historicalBasis:
- Historical attributions, claimed motives, changes of view, scholarly agreement and criticism must follow from an inspected excerpt. A related topic or valid evidenceId does not establish support. Preserve the speaker, conditions and scope. Identify the exact offending claim and evidential gap.
...
- Answer the resolved question. A definition does not need Gandhi evidence. A challenge must not defend an unsupported factual attribution by calling it inference. Missing evidence is not evidence that no record exists.
